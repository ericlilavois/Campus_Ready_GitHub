...
│  Final_Review — Scored applications ready for decision          │
│  Board_Essays — Essays formatted for board review               │
...
The scoring logic lives in sheet formulas (objective) and the board review workflow (subjective). Final decisions are made by reviewing the Final_Review tab.
...
| Application_Ops_Apps_Script | doPost handler, PDF generation, sheet writing, emails |
| Application_Admin_Apps_Script | Transfer and archive functions |
| Application_Rubric | Full scoring rubric with essay criteria and calibration details |
| Application_Reviews_Operations_Manual | Step-by-step review procedures |
